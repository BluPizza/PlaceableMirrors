...
{
    public class SandstoneWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.SandstoneWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeSandstoneMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.SmoothSandstone, ConfigValues.MaterialAmount)
