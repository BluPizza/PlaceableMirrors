...
{
    public class FunctionalBlueDungeonWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.FunctionalBlueDungeonWallMirror}");
        ...
        public override void AddRecipes()
        {
			...
			{
				CreateRecipe()
					.AddIngredient(ModContent.ItemType<Items.BlueDungeonWallMirror>())
