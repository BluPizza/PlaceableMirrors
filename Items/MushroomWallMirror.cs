...
{
    public class MushroomWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.MushroomWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeMushroomMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.GlowingMushroom, ConfigValues.MaterialAmount)
