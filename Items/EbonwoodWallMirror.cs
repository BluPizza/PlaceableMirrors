...
{
    public class EbonwoodWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.EbonwoodWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeEbonwoodMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.Ebonwood, ConfigValues.MaterialAmount)
