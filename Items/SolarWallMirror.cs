...
{
    public class SolarWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.SolarWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeSolarMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.SolarBrick, ConfigValues.MaterialAmount)
