...
{
    public class BambooWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.BambooWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeBambooMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.BambooBlock, ConfigValues.MaterialAmount)
