...
{
    public class PinkDungeonWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.PinkDungeonWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipePinkDungeonMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.PinkBrick, ConfigValues.MaterialAmount)
