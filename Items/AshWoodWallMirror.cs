...
{
    public class AshWoodWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.AshWoodWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeAshWoodMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.AshBlock, ConfigValues.MaterialAmount)
