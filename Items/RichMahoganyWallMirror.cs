...
{
    public class RichMahoganyWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.RichMahoganyWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeRichMahoganyMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.RichMahogany, ConfigValues.MaterialAmount)
