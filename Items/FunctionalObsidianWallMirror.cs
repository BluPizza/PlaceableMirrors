...
{
    public class FunctionalObsidianWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.FunctionalObsidianWallMirror}");
        ...
        public override void SetDefaults()
        {
			...
			Item.placeStyle = 15;
			Item.value = CalculateValue.GetFunctionalObsidianWallMirrorValue();
        }
