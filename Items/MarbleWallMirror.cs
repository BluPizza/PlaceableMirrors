...
{
    public class MarbleWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.MarbleWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeMarbleMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.MarbleBlock, ConfigValues.MaterialAmount)
