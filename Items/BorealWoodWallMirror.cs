...
{
    public class BorealWoodWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.BorealWoodWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeBorealWoodMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.BorealWood, ConfigValues.MaterialAmount)
