...
{
    public class FunctionalPearlwoodWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.FunctionalPearlwoodWallMirror}");
        ...
        public override void AddRecipes()
        {
			...
			{
				CreateRecipe()
					.AddIngredient(ModContent.ItemType<Items.PearlwoodWallMirror>())
