...
{
    public class DynastyWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.DynastyWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeDynastyMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.DynastyWood, ConfigValues.MaterialAmount)
