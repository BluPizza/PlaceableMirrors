...
{
    public class FunctionalEbonwoodWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.FunctionalEbonwoodWallMirror}");
        ...
        public override void AddRecipes()
        {
			...
			{
				CreateRecipe()
					.AddIngredient(ModContent.ItemType<Items.EbonwoodWallMirror>())
