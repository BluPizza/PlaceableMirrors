...
{
    public class GreenDungeonWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.GreenDungeonWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeGreenDungeonMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.GreenBrick, ConfigValues.MaterialAmount)
