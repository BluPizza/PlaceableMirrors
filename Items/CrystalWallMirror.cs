...
{
    public class CrystalWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.CrystalWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeCrystalMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.CrystalBlock, ConfigValues.MaterialAmount)
