...
{
    public class VortexWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.VortexWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeVortexMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.VortexBrick, ConfigValues.MaterialAmount)
