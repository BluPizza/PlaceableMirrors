...
{
    public class SpookyWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.SpookyWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeSpookyMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.SpookyWood, ConfigValues.MaterialAmount)
