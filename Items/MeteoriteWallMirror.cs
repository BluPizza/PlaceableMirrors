...
{
    public class MeteoriteWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.MeteoriteWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeMeteoriteMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.MeteoriteBrick, ConfigValues.MaterialAmount)
