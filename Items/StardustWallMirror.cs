...
{
    public class StardustWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.StardustWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeStardustMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.StardustBrick, ConfigValues.MaterialAmount)
