...
{
    public class GraniteWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.GraniteWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeGraniteMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.GraniteBlock, ConfigValues.MaterialAmount)
