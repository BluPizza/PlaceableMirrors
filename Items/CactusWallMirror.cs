...
{
    public class CactusWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.CactusWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeCactusMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.Cactus, ConfigValues.MaterialAmount)
