...
{
    public class BlueDungeonWallMirror : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.PlaceableMirrors.Items.BlueDungeonWallMirror}");
        ...
        {
			if (ModContent.GetInstance<PlaceableMirrorsServerRecipesConfig>().EnableRecipeBlueDungeonMirror)
			{
				CreateRecipe()
					.AddIngredient(ItemID.BlueBrick, ConfigValues.MaterialAmount)
