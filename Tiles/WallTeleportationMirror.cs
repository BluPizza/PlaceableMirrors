...
{
	public class WallTeleportationMirror : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("{$Mods.PlaceableMirrors.Tiles.TeleportationMirror}");
			AddMapEntry(new Color(255, 95, 252), name);
		...
		public override void DrawEffects(int x, int y, SpriteBatch sb, ref TileDrawInfo drawData)
		{
			...
			{
				Dust dust = Dust.NewDustDirect(new Vector2(x * 16, y * 16), 16, 16, DustID.Enchanted_Pink, 0f, 0f, 150, Color.GhostWhite, 1.2f);
				dust.noGravity = true;
			}
		}
		...
		{
			return ModContent.GetInstance<PlaceableMirrorsClientConfig>().EnableSmartInteractTeleportationMirror;
		}

		public override void KillMultiTile(int x, int y, int frameX, int frameY)
		{
			Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 48, 32, ModContent.ItemType<Items.WallTeleportationMirror>());
		}
