...
{
	public class TerraMirror : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("{$Mods.PlaceableMirrors.Tiles.TerraMirror}");
			AddMapEntry(new Color(34, 177, 76), name);
		...
		public override void DrawEffects(int x, int y, SpriteBatch sb, ref TileDrawInfo drawData)
		{
			...
			{
				Dust dust = Dust.NewDustDirect(new Vector2(x * 16, y * 16), 16, 16, DustID.TerraBlade, 0f, 0f, 150, default, 1.5f);
				dust.noGravity = true;
			}
		}
		...
		{
			return ModContent.GetInstance<PlaceableMirrorsClientConfig>().EnableSmartInteractTerraMirror;
		}

		public override void KillMultiTile(int x, int y, int frameX, int frameY)
		{
			Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 48, 32, ModContent.ItemType<Items.TerraMirror>());
		}
