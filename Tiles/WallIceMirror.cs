...
{
	public class WallIceMirror : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("{$Mods.PlaceableMirrors.Tiles.LargeIceMirror}");
			AddMapEntry(new Color(180, 243, 250), name);
		...
		{
			return ModContent.GetInstance<PlaceableMirrorsClientConfig>().EnableSmartInteractIceMirror;
		}

		public override void KillMultiTile(int x, int y, int frameX, int frameY)
		{
			Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 48, 32, ModContent.ItemType<Items.WallIceMirror>());
		}
		...
		{
			PlaceableMirrors.MouseOverMirrors(x, y, ModContent.ItemType<Items.WallIceMirror>());
		}
